...
COMMON_SYS_POOL_CFG_T gtSysCommPoolSingleSc450aiSdr[] = {
    ...
    {2688, 1520, 2688, AX_FORMAT_YUV420_SEMIPLANAR, 4},    /* vin nv21/nv21 use */
    {1920, 1080, 1920, AX_FORMAT_YUV420_SEMIPLANAR, 8},    /* vin nv21/nv21 use */
    {720, 576, 720, AX_FORMAT_YUV420_SEMIPLANAR, 3},    /* vin nv21/nv21 use */
};

COMMON_SYS_POOL_CFG_T gtPrivatePoolSingleSc450aiSdr[] = {
    {2688, 1520, 2688, AX_FORMAT_BAYER_RAW_10BPP_PACKED, 12, AX_COMPRESS_MODE_LOSSY, 4},      /* vin raw10 use */
};
...
static int SAMPLE_IVPS_Init(AX_S32 nGrpId, AX_S32 nChnNum, AX_IVPS_ROTATION_E eRotAngle)
{
    ...
    stPipelineAttr.tFilter[ALGO_CHN + 1][0].eEngine = AX_IVPS_ENGINE_VPP;
...
AX_VOID PrintHelp()
{
    ...
    printf("\nOS04A10:\n");
    printf("\nExample:\n\tdepth_anything -c 1 -m 1 -e 1 -r 1\n");

    printf("\nSC450AI:\n");
    printf("\nExample:\n\tdepth_anything -c 2 -m 1 -e 1 -r 1\n");
}
...
{
    ALOGI2("Depth Anything Sample. Build at %s %s", __DATE__, __TIME__);
